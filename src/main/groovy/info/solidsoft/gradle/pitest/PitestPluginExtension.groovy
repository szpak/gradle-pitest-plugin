...
//@CompileStatic together with setReportDir(String reportDirAsString) causes:
//ClassNotFoundException: org.gradle.api.file.FileSystemLocationProperty on extension initialization
@CompileStatic
