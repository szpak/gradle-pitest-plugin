 ...
 */
public class PitestJavaReportsContainerImpl extends TaskReportContainer<Report> implements PitestJavaReportsContainer {

    public PitestJavaReportsContainerImpl(Task task) {
