...
class PitestPluginGradleVersionFunctionalSpec extends AbstractPitestFunctionalSpec {
    ...
    private static final List<String> GRADLE8_VERSIONS = [LATEST_KNOWN_GRADLE_VERSION.version, "8.14.4", "8.13", "8.12.1", "8.11.1", "8.10.2",
                                                          "8.9", "8.8", "8.7", "8.6.4", "8.5", "8.4", "8.3", "8.2.1", "8.1.1", "8.0.2"]
    private static final List<String> GRADLE9_VERSIONS = ["9.3.1", "9.2.1", "9.1.0", "9.0.0"]
