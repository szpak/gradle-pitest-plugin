...
class PitestPluginGradleVersionFunctionalSpec extends AbstractPitestFunctionalSpec {
    ...
    private static final GradleVersion LATEST_KNOWN_GRADLE_VERSION = GradleVersion.version("7.5.1")
    ...
    private static final List<String> GRADLE7_VERSIONS = [LATEST_KNOWN_GRADLE_VERSION.version, "7.4.1", "7.3.3", "7.2", "7.1.1", "7.0.2"]
