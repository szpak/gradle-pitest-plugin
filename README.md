...
Note that when making `pitest` depend on another task, it must be referred to by name. Or else Gradle will resolve `pitest` to the configuration and not the task.
